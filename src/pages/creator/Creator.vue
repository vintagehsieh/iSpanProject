      ...
      <div>
        <div class="width-navbar-dark position-relative work-page-header-wrapper mb-3" id="inside_box">
          <div class="blur-cover-block">
            <img
              :src="creator?.creatorCover ?? 'https://localhost:44373/Uploads/Covers/puppy.jpg'"
              ...
              <div class="col-md-4">
                <div class="border-block p-1 m-3" >
                  <div class="cover-block " >
                    <img
                      :src="creator?.creatorPic ?? 'https://localhost:44373/Uploads/Covers/puppy.jpg'"
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          ...
          <a-form-item label="自我介紹" name="自我介紹">
            <a-textarea name="CreatorAbout" v-model:value="creator.creatorAbout" :auto-size="{ minRows: 32, maxRows: 32 }" />
          </a-form-item>
