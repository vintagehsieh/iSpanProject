...
<template>
  <a-layout class="px-5 py-3">
    <a-layout-content>
      <div>
        <div
          class="width-navbar-dark position-relative work-page-header-wrapper mb-3"
          id="inside_box"
        >
          ...
          <div class="overflow-auto invisible-scrollbar" style="height: 410px">
            ...
            <div v-else class="vstack gap-3">
              <div
                v-for="song in songs"
                :key="song.Id"
                class="hstack align-items-center gap-3 p-3 songitme rounded border"
                role="button"
              ...
              >
                ...
                <span
                  class="ms-auto bi-x-lg text-danger"
                  role="button"
      ...
      <a-modal
        v-model:visible="deletesongconfirm_visible"
        title="刪除歌曲"
        ok-text="確認"
        cancel-text="取消"
        @ok="deleteSong()"
      ...
      <a-modal
        v-model:visible="deletealbumconfirm_visible"
        title="刪除專輯"
        ok-text="確認"
        cancel-text="取消"
        @ok="deleteAlbum()"
      ...
      <a-modal
        width="1200px"
        v-model:visible="addsongvisible"
        :footer="null"
        :afterClose="getSongs"
        destroyOnClose
      >
      ...
      <a-modal
        width="1200px"
        v-model:visible="songdetialvisible"
        :footer="null"
        :afterClose="getSongs"
        destroyOnClose
      >
        ...
        <SongDetail
          :Song="selectedsong"
          :CreateID="creator.id"
          @close="songdetialvisible = false"
        ></SongDetail>
      </a-modal>

      <a-modal
        width="1200px"
        v-model:visible="addalbumvisible"
        :footer="null"
        :afterClose="getAlbums"
        destroyOnClose
      >
        <template #title>
        ...
        <AddAlbum
          ...
          "
          @close="addalbumvisible = false"
        ></AddAlbum>
      </a-modal>
      <a-modal
        width="1200px"
        v-model:visible="albumdetialvisible"
        :footer="null"
        :afterClose="getAlbums"
        destroyOnClose
      >
        ...
        <AlbumDetail
          ...
          :Album="selectedalbum"
          :CreateID="creator.id"
          @close="albumdetialvisible = false"
        ></AlbumDetail>
      </a-modal>
          ...
          <div class="row">
            <div class="col-lg-6 col-12">
              <a-form-item label="暱稱" name="暱稱">
                <a-input
                  name="CreatorName"
                  v-model:value="creator.creatorName"
                />
              </a-form-item>
              <a-form-item label="自我介紹" name="自我介紹">
                <a-textarea
                  name="CreatorAbout"
                  v-model:value="creator.creatorAbout"
