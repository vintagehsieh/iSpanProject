  ...
  <a-layout class="px-5 py-3">
    <a-layout-content>
              ...
              <div class="col-md-4">
                <div class="border-block p-1 m-3">
                  <div class="cover-block ">
                    <img
                      :src="'data:image/png;base64,' + creator?.creatorPic ?? ''"
                      width="300" height="300" style="display:block; margin:auto;">
                  </div>
                </div>
              </div>
              <div class="col-md-4 work-page-header-wrapper-right p-4">
                <h1 class="text-white " style="font-size:100px">{{ creator.creatorName }}</h1>
                <h3 class="text-truncate text-white opacity-72">{{ creator.creatorAbout }}</h3>
                <ul class="list-inline text-white opacity-72 text-white mt-5">
                  <li class="list-inline-item mr-5">
                    <h4 class="font-weight-normal text-secondary">音樂</h4>
                    <div class="mb-0 fs-1 fw-bolder  text-secondary">{{ songs.length }}</div>
                  </li>
                  <li class="list-inline-item">
                    <h4 class="font-weight-normal text-secondary">專輯</h4>
                    <div class="mb-0 fs-1 fw-bolder text-secondary">{{ albums.length }}</div>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <a-modal v-model:visible="deletesongconfirm_visible" title="刪除歌曲" ok-text="確認" cancel-text="取消" @ok="deleteSong()">
        <p>確定要刪除歌曲: <span class="text-danger">{{ deletesongobject?.SongName }}</span> 嗎?</p>
      </a-modal>

      <a-modal v-model:visible="deletealbumconfirm_visible" title="刪除專輯" ok-text="確認" cancel-text="取消"
        @ok="deleteAlbum()">
        <p>確定要刪除專輯: <span class="text-danger">{{ deletealbumobject?.AlbumName }}</span> 嗎?</p>
      </a-modal>
      ...
      <a-modal width="1200px" v-model:visible="addsongvisible" :footer="null" :afterClose="getSongs" destroyOnClose>
        ...
        <AddSong :ID="creator.id" @close="addsongvisible = false"
          :AlbumList="albums.map(x => { return { value: x.Id, label: x.AlbumName } })"></AddSong>
      </a-modal>
      ...
      <a-modal width="1200px" v-model:visible="addalbumvisible" :footer="null" :afterClose="getAlbums" destroyOnClose>
        ...
        <AddAlbum :ID="creator.id"
          :SongList="songs.map(x => { return { Id: x.Id, SongName: x.SongName, SongWriter: x.SongWriter } })"
      ...
      <a-modal width="1200px" v-model:visible="albumdetialvisible" :footer="null" :afterClose="getAlbums" destroyOnClose>
        ...
        <AlbumDetail :SongList="songs.map(x => { return { Id: x.Id, SongName: x.SongName, SongWriter: x.SongWriter } })"
...
const getUserInfo = async () => {
  await axios.get(`https://localhost:7043/Creators/${UserID.value}/CreatorPage`, {
...
const getSongs = () => {
  ...
  axios.get(`https://localhost:7043/Creators/${creator.value.id}/songs`, {
    withCredentials: true,
  })
    .then((res) => {
...
const albums = ref([]);
const getAlbums = () => {
  axios.get(`https://localhost:7043/Creators/${creator.value.id}/albums`, {
    withCredentials: true,
  })
    .then((res) => {
...
const deleteSong = () => {
  ...
  axios.post(`https://localhost:7043/Creators/${creator.value.id}/song_creator_Metadata/${deletesongobject.value.Id}`, senddata, {
    withCredentials: true,
  })
    .then((res) => {
      alert(res.data);
...
const deleteAlbum = () => {
  ...
  axios.post(`https://localhost:7043/Creators/${creator.value.id}/deletealbum/${deletealbumobject.value.Id}`, senddata, {
    withCredentials: true,
  })
    .then((res) => {
      alert(res.data);
