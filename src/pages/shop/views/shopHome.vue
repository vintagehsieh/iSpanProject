...
<template>
    <div class="content">
        ...
        <ul class="categorySearch">
            <button class="category" @click="returnpProducts()">
                發燒音樂
            </button>
            <button
                class="category"
                @click="getProductsByGenreName(genreName[0])"
            >
                華語流行音樂
            </button>
            <button
                class="category"
                @click="getProductsByGenreName(genreName[1])"
            >
                西洋流行音樂
            </button>
            <button
                class="category"
                @click="getProductsByGenreName(genreName[2])"
            >
                韓語流行音樂
            </button>
            <button
                class="category"
                @click="getProductsByGenreName(genreName[3])"
            >
                日語流行音樂
            </button>
        </ul>
